...
app.get('/test-db', async (req, res) => {
    try {
        ...
        res.json({
            ...
            message: userCount === 0 ? 'No users found - run seedData.js' : 'Data exists'
        });
...
// Add route to create single test user
app.get('/quick-setup', async (req, res) => {
    try {
        const User = require('./models/User');
        const Account = require('./models/Account');
        ...
        res.json({
            ...
            credentials: {
                customer: { email: 'test@test.com', password: '123456' },
